...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/FDHL', donate)
            break
        case '!tts':
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '18623216664@c.us')
            break
        case '!ig':
        ...
        case '!linkgroup':
            ...
            break
        case '!bc':
            if (!isOwner) return client.reply(from, 'MAU PROMOSI? WHATSAPP SAYA', id)
            let msg = body.slice(4)
            const chatz = await client.getAllChatIds()
            for (let ids of chatz) {
                var cvk = await client.getChatById(ids)
                if (!cvk.isReadOnly) await client.sendText(ids, `[ FADHIL SANS Broadcast ]\n\n${msg}`)
            }
        ...
        case '!demote':
            ...
            break
        case '!join':
            //return client.reply(from, 'Jika ingin meng-invite bot ke group anda, silahkan izin ke wa.me/18623216664', id)
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, 'https://github.com/fadhilsans/wa-bot', info)
            break
        case '!snk':
